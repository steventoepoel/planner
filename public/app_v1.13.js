/* Toepoel's Reisplanner — app.js (v1.13)
...
for(let h=0; h<24; h++){
  ...
  hourSelect && hourSelect.appendChild(o);
}
for(let m=0; m<60; m+=5){
  const o=document.createElement("option");
  o.value=pad2(m); o.textContent=pad2(m);
  minuteSelect && minuteSelect.appendChild(o);
}
...
if(dateInput) dateInput.value = localISODate(now);
